    ...
    public void create(Usuario usuario) {
        ...
        try {
            ...
            for (Movimento movimentoCollectionMovimento : usuario.getMovimentoCollection()) {
                Usuario oldUsuarioidUsuarioOfMovimentoCollectionMovimento = movimentoCollectionMovimento.getIdUsuario();
        ...
        try {
            ...
            for (Movimento movimentoCollectionNewMovimento : movimentoCollectionNew) {
                if (!movimentoCollectionOld.contains(movimentoCollectionNewMovimento)) {
                    Usuario oldUsuarioidUsuarioOfMovimentoCollectionNewMovimento = movimentoCollectionNewMovimento.getIdUsuario();
